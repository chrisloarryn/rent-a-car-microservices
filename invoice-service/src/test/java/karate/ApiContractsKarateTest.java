...
import com.kodlamaio.invoiceservice.InvoiceServiceApplication;
...
class ApiContractsKarateTest
{
    ...
    void configureBaseUrlAndSeedData()
    {
        ...
        System.setProperty("karate.seedId", invoice.getId().toString());
        System.setProperty("karate.seedPlate", invoice.getPlate());
    }
